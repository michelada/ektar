...
class Ektar::User < Ektar::ApplicationRecord
  ...
  include Anonymous_ActiveModel_SecurePassword_InstanceMethodsOnActivation_29
...
module Ektar::User::GeneratedRelationMethods
  def super_admins(*args, &block); end
end
...
module Anonymous_ActiveModel_SecurePassword_InstanceMethodsOnActivation_29
