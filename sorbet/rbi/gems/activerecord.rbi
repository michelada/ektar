...
class Arel::Attributes::Attribute < Anonymous_Struct_435
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_436
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_437
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_438
  def accessor; end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::TypeMetadata < Anonymous_Delegator_439
  def ==(other); end
  def eql?(other); end
  def fmod; end
  def hash; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_440
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_441
  def deserialize(value); end
  def encode_with(coder); end
  def init_with(coder); end
  def serialize(value); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_442
  def cast(value); end
