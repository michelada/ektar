...
class Arel::Attributes::Attribute < Anonymous_Struct_452
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_453
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_454
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_455
  def accessor; end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::TypeMetadata < Anonymous_Delegator_456
  def ==(other); end
  def deduplicated; end
  def eql?(other); end
  def fmod; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_457
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_458
  def deserialize(value); end
  def encode_with(coder); end
  def init_with(coder); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_459
  def cast(value); end
...
module Ektar::Plan::GeneratedRelationMethods
  def with_rich_text_description(**, &&); end
  def with_rich_text_description_and_embeds(**, &&); end
end
