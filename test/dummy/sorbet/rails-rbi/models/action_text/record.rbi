...
# Please rerun rake rails_rbi:models[ActionText::Record] to regenerate.
...
class ActionText::Record < ActiveRecord::Base
  ...
  sig { params(args: T.untyped).returns(ActionText::Record) }
  def self.find(*args); end

  sig { params(args: T.untyped).returns(T.nilable(ActionText::Record)) }
  def self.find_by(*args); end

  sig { params(args: T.untyped).returns(ActionText::Record) }
  def self.find_by!(*args); end

  sig { returns(T.nilable(ActionText::Record)) }
  def self.first; end

  sig { returns(ActionText::Record) }
  def self.first!; end
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(ActionText::Record) }
...
class ActionText::Record::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(ActionText::Record::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
  ...
  sig { override.params(block: T.proc.params(e: ActionText::Record).void).returns(T::Array[ActionText::Record]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[ActionText::Record]) }
  def flatten(level); end

  sig { returns(T::Array[ActionText::Record]) }
  def to_a; end
