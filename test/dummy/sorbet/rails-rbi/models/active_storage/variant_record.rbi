...
# Please rerun rake rails_rbi:models[ActiveStorage::VariantRecord] to regenerate.
...
class ActiveStorage::VariantRecord < ActiveStorage::Record
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(ActiveStorage::VariantRecord) }
...
class ActiveStorage::VariantRecord::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(ActiveStorage::VariantRecord::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
  ...
  sig { override.params(block: T.proc.params(e: ActiveStorage::VariantRecord).void).returns(T::Array[ActiveStorage::VariantRecord]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[ActiveStorage::VariantRecord]) }
