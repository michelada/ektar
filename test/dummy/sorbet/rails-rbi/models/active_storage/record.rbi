...
# Please rerun rake rails_rbi:models[ActiveStorage::Record] to regenerate.
...
class ActiveStorage::Record < ActiveRecord::Base
  ...
  sig { params(args: T.untyped).returns(ActiveStorage::Record) }
  def self.find(*args); end

  sig { params(args: T.untyped).returns(T.nilable(ActiveStorage::Record)) }
  def self.find_by(*args); end

  sig { params(args: T.untyped).returns(ActiveStorage::Record) }
  def self.find_by!(*args); end

  sig { returns(T.nilable(ActiveStorage::Record)) }
  def self.first; end

  sig { returns(ActiveStorage::Record) }
  def self.first!; end
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(ActiveStorage::Record) }
...
class ActiveStorage::Record::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(ActiveStorage::Record::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
  ...
  sig { override.params(block: T.proc.params(e: ActiveStorage::Record).void).returns(T::Array[ActiveStorage::Record]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[ActiveStorage::Record]) }
  def flatten(level); end

  sig { returns(T::Array[ActiveStorage::Record]) }
  def to_a; end
